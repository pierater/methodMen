...
```{r}
  ...
  barplot(head(sort(table(data$artist), decreasing = T), 5), horiz = T, las = 1, xlab = "Number of songs per artist", ylab = "Artist")
...
d = dist(data)
fit = cmdscale(d)
plot(fit[data$artist == 'chris-brown'], col='orange')
